...
int readingNum = 0; // declare a counter variable to remember how many readings
// have been completed
...
void loop()
{
  ...
  while (switchState == LOW)
  {
    ...
    readingNum += 1; // add 1 to readingNum after each complete reading
    switchState = digitalRead(switchPin); // check switchPin
  }
